...
AJS.SelectModel = AJS.Control.extend({
    ...
    setSelected: function (descriptor) {
        ...
        // Remove highlighting. If this ItemDescriptor is reused, the old highlighting will appear.
        // @see AJS.List.prototype._filterOptions -- Highlighted item are passed straight through
