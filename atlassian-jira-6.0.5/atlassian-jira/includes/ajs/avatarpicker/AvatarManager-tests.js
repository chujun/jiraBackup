...
test("getAvatarSrc", function ()
{
    ...
    equals(avatarManager.getAvatarSrc(avatar, JIRA.Avatar.SMALL), "/secure/projectavatar?avatarId=1002&size=small&ownerId=undefined");
    equals(avatarManager.getAvatarSrc(anotherAvatar, JIRA.Avatar.MEDIUM), "/secure/projectavatar?avatarId=999&size=medium&ownerId=undefined");
    equals(avatarManager.getAvatarSrc(anotherAvatar, JIRA.Avatar.LARGE), "/secure/projectavatar?avatarId=999&size=large&ownerId=undefined");
});