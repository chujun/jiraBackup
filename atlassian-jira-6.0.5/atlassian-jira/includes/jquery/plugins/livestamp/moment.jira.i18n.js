(function (moment) {
    ...
    var relativize = AJS.Meta.getBoolean("date-relativize"),
        meridiem = JIRA.getDateFormatSymbol("amPmStrings"),
        map = {
            d: "D",       // day
            y: "Y",       // year
            a: "A",       // meridiem
    ...
    moment.lang("jira", {
        ...
        calendar: {
            sameDay:  relativize ? AJS.I18n.getText("common.date.relative.day.same", "[", "]", "LT") : "LLL",
            nextDay:  relativize ? AJS.I18n.getText("common.date.relative.day.next", "[", "]", "LT") : "LLL",
            nextWeek: relativize ? AJS.I18n.getText("common.date.relative.days.next", "[", "]", "L") : "LLL",
            lastDay:  relativize ? AJS.I18n.getText("common.date.relative.day.last", "[", "]", "LT") : "LLL",
