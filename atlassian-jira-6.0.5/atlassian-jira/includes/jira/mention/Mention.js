    ...
    textarea: function(textarea) {
        ...
        if (textarea) {
            ...
            if (this.$textarea.attr("push-scroll")) {
                ...
                // it might end using AJS.InlineLayer.WindowPositioning, that conflicts with the intention of
                // pushing scroll
                var positioningController = new AJS.InlineLayer.StandardPositioning();
                var scrollPusher = JIRA.Mention.ScrollPusher(this.$textarea, 10);
            }
...
JIRA.Mention.ScrollPusher = function($el, defaultMargin) {
    defaultMargin = defaultMargin || 0;

    var $scroll = AJS.$($el.attr("push-scroll")),
