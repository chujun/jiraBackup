AJS.namespace('JIRA.ShifterComponent.ShifterSelect', window, AJS.QueryableDropdownSelect.extend({
    /**
     * @param options.id
     * @param options.element
     * @param {Array[ShifterGroup]} options.groups
    ...
    _createListController: function () {
        var instance = this;
        this.listController = new AJS.ListWithMessages({
            ...
            selectionHandler: function(e) {
                ...
                if (targetData && targetData.descriptor instanceof AJS.MessageDescriptor ) {
