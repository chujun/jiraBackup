AJS.namespace('JIRA.ShifterComponent.ShifterDialog', window, Class.extend({
    BLUR_DELAY: 50,

    /**
     * @param {String} id - unique id for this dialog
     * @param {Array[ShifterGroup]} groups
    ...
    _render: function() {
        ...
        var shifterSelect = this.shifterSelect = new JIRA.ShifterComponent.ShifterSelect({
            id: this.id,
                    ...
                    return group.getSuggestions(query).done(function(groupSuggestions) {
                        ...
                        suggestions.push(new AJS.GroupDescriptor({
                            ...
                            items: _.map(groupSuggestions, function(suggestion) {
                                return AJS.ItemDescriptor.create(suggestion, groupIndex);
                            })
                        }));
