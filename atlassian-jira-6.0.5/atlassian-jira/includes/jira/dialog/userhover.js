 ...
 *   -- The scope in which to look for ".user-hover" elements.  The element must have a "rel" attribute
 *      with the target's username as the value.
 */
...
JIRA.userhover._fetchDialogContents = function($contents, trigger, showPopup) {
    AJS.$.get(JIRA.userhover.INLINE_DIALOG_OPTIONS.urlPrefix + encodeURIComponent(trigger.getAttribute("rel")), function(html) {
