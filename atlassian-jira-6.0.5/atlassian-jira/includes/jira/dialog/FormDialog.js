    ...
    decorateContent: function () {
        ...
        if($cancel.length == 0 && $buttons.length == 0) {
            if($buttonContainer.length == 0) {
                $footerContainer = AJS.$('<div class="buttons-container form-footer"><div class="buttons"/></div>').appendTo(this.get$popupContent());
                $buttonContainer = $footerContainer.find(".buttons");
            }

            AJS.populateParameters();
            $closeLink = AJS.$("<button class='aui-button aui-button-link cancel' id='aui-dialog-close'>" + AJS.I18n.getText("admin.common.words.close") + "</button>");
