    ...
    setup: function() {
        ...
        this.assert = {
            ...
            fieldValues: function (type) {
                ...
                equals(JSON.stringify(values), JSON.stringify(args));
            ...
            submitVals: function (from, to, startDate, endDate) {
                equals($from.val(), from, "Expected 'from' value to be [" + from + "] but was [" + $from.val() + "]");
                equals($to.val(), to, "Expected 'to' value to be [" + to + "] but was [" + $to.val() + "]");
                equals($dateStart.val(), startDate, "Expected 'dateStart' value to be [" + startDate + "] but was [" + $dateStart.val() + "]");
                equals($dateEnd.val(), endDate, "Expected 'dateStart' value to be [" + endDate + "] but was [" + $dateEnd.val() + "]");
            }
        };
    },
    teardown: function () {
