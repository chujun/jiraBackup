...
JIRA.JQLAutoComplete = function (options) {
    ...
    that.renderSuggestions = function ( suggestions, moreSuggestions, operatorSuggestions) {
        ...
        if (suggestions instanceof Array)
        {
            ...
            var syntaxHelpLink = AJS.$('<a class="syntax-help" target="_jiraHelp"></a>')
                .attr('title', AJS.Meta.get('advanced-search-help-title'))
                .attr('href', AJS.Meta.get('advanced-search-help-url'))
