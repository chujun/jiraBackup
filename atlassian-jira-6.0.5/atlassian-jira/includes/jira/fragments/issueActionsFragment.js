...
JIRA.FRAGMENTS.issueActionsFragment = function () {
    ...
    return function(json) {
        ...
        var htmlParts = [
            '<div class="aui-list"><ul class="aui-list-section"><li class="aui-list-item"><a class="aui-list-item-link issue-link" data-issue-key="',
            json.key,
            '" href="',
            contextPath,
            "/browse/",
        ...
        if (hasActions) {
            ...
            AJS.$.each(json.actions, function() {
                htmlParts.push(
                    ...
                    '" rel="',
                    this.action,
                    '" class="aui-list-item-link issueaction-workflow-transition" data-issueId="' + json.id + '" data-issueKey="' + json.key + '">',
