            ...
            <p>
                ...
                <ww:else>
                    <ww:text name="'admin.workflow.infobox.editing.draft.view.original'">
                        ...
                        <ww:param name="'value1'"></a></ww:param>
                        <ww:param name="'value2'"><a id="publish_draft_workflow" href="<ww:url page="PublishDraftWorkflow!default.jspa"><ww:param name="'workflowMode'" value="'draft'"/><ww:param name="'workflowName'" value="/workflow/name"/><ww:param name="'project'" value="/project" /></ww:url>"></ww:param>
                    </ww:text>
