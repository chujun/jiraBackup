                    ...
                    <ww:if test="/attachable == true || /screenshotAttachable == true || /zipSupport == true">
                        <ul class="ops">
                            ...
                            <ww:if test="/screenshotAttachable == true">
                                <li>
                                    <a class="button<ww:if test="/attachable == false && /zipSupport == false"> first</ww:if> last issueaction-attach-screenshot" href="<ww:url value="'AttachScreenshot!default.jspa'"  >
