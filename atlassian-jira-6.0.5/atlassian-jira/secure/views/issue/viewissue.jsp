...
<body class="<ww:if test="/useKickAss() == true">ka page-type-navigator navigator-collapsed navigator-issue-only standalone-viewissue</ww:if><ww:else>page-type-viewissue standalone-viewissue</ww:else>">
