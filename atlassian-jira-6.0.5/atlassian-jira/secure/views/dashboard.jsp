    ...
    <script type="text/javascript">
        AJS.$(function() {
            ...
            if (AJS.params.showWhitelistUpgradeWarning) {
                ...
                var $warning = AJS.$('<div id="applinks-upgrade-warning" class="aui-message warning"><p><span class="aui-icon aui-icon-warning"></span>' + message + '</p></div>');

                $warning.prependTo('#header');
            }
        });
    </script>
</head>
