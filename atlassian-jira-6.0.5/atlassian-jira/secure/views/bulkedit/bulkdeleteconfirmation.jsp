                ...
                <ui:param name="'content'">
                    ...
                    <page:applyDecorator id="bulkdelete" name="auiform">
                        ...
                        <p>
                            ...
                            />
                            <a class="aui-button aui-button-link" id="cancel" href="<ww:url value="/secure/BulkCancelWizard.jspa"/>"><ww:text name="'common.forms.cancel'"/></a>
                        </p>
                        ...
                        <p>
                            ...
                            />
                            <a class="aui-button aui-button-link" id="cancel-bottom" href="<ww:url value="/secure/BulkCancelWizard.jspa"/>"><ww:text name="'common.forms.cancel'"/></a>
                        </p>
