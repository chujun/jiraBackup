                                        ...
                                        <td>
                                            <ww:if test="loggedInUserIsOwner(.) == true" >
                                                <ul class="operations-list">
                                                    <li><a class="trigger-dialog" id="edit_subscription" href="<ww:url value="'FilterSubscription!default.jspa'"><ww:param name="'subId'" value="long('id')" /><ww:param name="'filterId'" value="filterId" /></ww:url>"><ww:text name="'common.words.edit'"/></a></li>
