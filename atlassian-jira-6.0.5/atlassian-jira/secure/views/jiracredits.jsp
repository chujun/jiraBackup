...
.msie-8 .crew li strong {
    background: transparent url("<%= request.getContextPath() %>/images/invader-charlie.gif") no-repeat 0 0;
}
.msie-8 .crew li span {
    box-shadow: none;
}
...
<div id="stage">
    ...
    <div id="credits">
        ...
        <ol class="crew" id="five">
            ...
            <li data-details="Renjith Pillai &mdash; support"><strong><span>Renjith Pillai &mdash; support &amp; bugfix</span></strong></li>
