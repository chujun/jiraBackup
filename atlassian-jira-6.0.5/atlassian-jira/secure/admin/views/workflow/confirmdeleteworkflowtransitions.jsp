...
<body>
    ...
    <page:applyDecorator name="jiraform">
    	...
    	<page:param name="cancelURI"><ww:url page="ViewWorkflowTransition.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="/selectedTransitions/iterator/next/id" /></ww:url></page:param>
