...
<ww:if test="/descriptorTab == 'all' || /descriptorTab == 'conditions'">
    ...
    <ww:if test="workflow/editable == true">
        ...
        <ww:text name="'admin.workflowtransition.addnewcondition'">
            <ww:param name="'value0'"><a id="add_new_condition" href="<ww:url page="AddWorkflowTransitionCondition!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>"><b></ww:param>
...
<ww:if test="/descriptorTab == 'all' || /descriptorTab == 'postfunctions'">
    ...
    <ww:if test="transition/unconditionalResult">
        ...
        <ww:text name="'admin.workflowtransition.add.new.post.function'">
            <ww:param name="'value0'"><a id="add_post_func" href="<ww:url page="AddWorkflowTransitionPostFunction!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>"><b></ww:param>
            <ww:param name="'value1'"></b></a></ww:param>
        </ww:text>
    </ww:if>
    <p>
