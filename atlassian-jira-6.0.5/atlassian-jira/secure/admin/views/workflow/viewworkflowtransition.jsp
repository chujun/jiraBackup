    ...
    <ul class="square">
        ...
        <ww:if test="/workflow/editable == true">
            <li><ww:text name="'admin.workflowtransition.edittransition'">
                <ww:param name="'value0'"><a href="<ww:url page="EditWorkflowTransition!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>" id="edit_transition"><b></ww:param>
                <ww:param name="'value1'"></b></a></ww:param>
            </ww:text></li>
            <ww:if test="/global == false && /initial == false">
                <li><ww:text name="'admin.workflowtransition.deletetransition'">
                    <ww:param name="'value0'"><a id="delete_transition" href="<ww:url page="DeleteWorkflowTransitions!confirm.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'transitionIds'" value="transition/id" /></ww:url>"><b></ww:param>
                    <ww:param name="'value1'"></b></a></ww:param>
                </ww:text></li>
            </ww:if>
        </ww:if>
        <li><ww:text name="'admin.workflowtransition.viewproperties'">
            <ww:param name="'value0'"><a id="view_transition_properties" href="<ww:url page="ViewWorkflowTransitionMetaAttributes.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>"><b></ww:param>
            <ww:param name="'value1'"></b></a></ww:param>
        </ww:text></li>
    </ul>
                    ...
                    <ww:iterator value="/stepsForTransition">
                        <tr>
                            <td style="border: 1px solid #bbb;" bgcolor="#ffffff" align="left" nowrap>
                                <a href="<ww:url page="ViewWorkflowStep.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="id" /></ww:url>"><ww:property value="name" /></a>
                            </td>
...
<tr>
	...
	<ww:else>
		<td width="1%" nowrap align="center">
			&nbsp;<b><a id="view_all_trans" href="<ww:url page="ViewWorkflowTransition.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="/transition/id" /><ww:param name="'descriptorTab'" value="'all'" /></ww:url>"><ww:text name="'admin.workflowtransition.all'"/></a></b>&nbsp;
		</td>
	</ww:else>
	...
	<ww:elseIf test="/showOtherTab == true">
		<td width="1%" nowrap align="center">
			&nbsp;<b><a id="view_other" href="<ww:url page="ViewWorkflowTransition.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="/transition/id" /><ww:param name="'descriptorTab'" value="'other'" /></ww:url>"><ww:text name="'admin.workflowtransition.other'"/></a></b>&nbsp;
		</td>
	</ww:elseIf>
