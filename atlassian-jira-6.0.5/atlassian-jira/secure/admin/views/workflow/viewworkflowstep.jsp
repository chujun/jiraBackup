        ...
        <ww:if test="/workflow/editable == true">
            <ww:if test="/stepWithoutTransitionsOnDraft(/step/id) == false">
                <li><ww:text name="'admin.workflowstep.add.outgoing.transition'">
                    <ww:param name="'value0'"><a id="add_transition" href="<ww:url page="AddWorkflowTransition!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'originatingUrl'" value="'viewWorkflowStep'" /></ww:url>"><b></ww:param>
                    <ww:param name="'value1'"></b></a></ww:param>
                </ww:text></li>
            </ww:if>
            <ww:if test="/step/actions/empty == false">
                <li><ww:text name="'admin.workflowstep.delete.outgoing.transitions'">
                    <ww:param name="'value0'"><a id="del_transition" href="<ww:url page="DeleteWorkflowTransitions!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'originatingUrl'" value="'viewWorkflowStep'" /></ww:url>"><b></ww:param>
                    <ww:param name="'value1'"></b></a></ww:param>
                </ww:text></li>
            </ww:if>
            <li><ww:text name="'admin.workflowstep.edit.step'">
                <ww:param name="'value0'"><a id="edit_step" href="<ww:url page="EditWorkflowStep!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'originatingUrl'" value="'viewWorkflowStep'" /></ww:url>"><b></ww:param>
                <ww:param name="'value1'"></b></a></ww:param>
            </ww:text></li>
            <ww:if test="canDeleteStep(/step) == true">
                <li><ww:text name="'admin.workflowstep.delete.step'">
                    <ww:param name="'value0'"><a id="del_step" href="<ww:url page="DeleteWorkflowStep!default.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'originatingUrl'" value="'viewWorkflowStep'" /></ww:url>"><b></ww:param>
                    <ww:param name="'value1'"></b></a></ww:param>
                </ww:text></li>
            </ww:if>
        </ww:if>
        <li><ww:text name="'admin.workflowstep.viewproperties'">
            <ww:param name="'value0'"><a id="view_properties_<ww:property value="/step/id"/>" href="<ww:url page="ViewWorkflowStepMetaAttributes.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /></ww:url>"><b></ww:param>
            <ww:param name="'value1'"></b></a></ww:param>
        </ww:text></li>
    </ul>
</page:applyDecorator>
                            ...
                            <tr>
                                <td style="border: 1px solid #bbb;" bgcolor="#f0f0f0" nowrap>
                                    <ww:if test="/global(.) == true">
                                        <em><a id="view_transition_<ww:property value="id" />" href="<ww:url page="ViewWorkflowTransition.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowTransition'" value="id" /></ww:url>"
                        ...
                        <ww:iterator value="/outboundTransitions">
                            <tr>
                                ...
                                <td align="left" style="border: 1px solid #bbb;" bgcolor="#f0f0f0"  nowrap>
                                    ...
                                    <ww:else>
                                        <ww:if test="/common(.) == true"><em></ww:if>
                                        <a href="<ww:url page="ViewWorkflowTransition.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="id" /></ww:url>"
                                           <ww:if test="metaAttributes/('jira.description')">title="<ww:property value="metaAttributes/('jira.description')"/>"</ww:if>><ww:property value="name" /></a>
                                        <ww:if test="/common(.) == true"></em></ww:if>
                                    </ww:else>
                                    <span class="smallgrey">(<ww:property value="id" />)</span>
