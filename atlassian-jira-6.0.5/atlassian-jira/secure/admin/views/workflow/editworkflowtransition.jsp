            ...
            <ww:if test="/nameI8n">
                <div class="infoBox">
                    <ww:text name="'admin.workflowtransitions.update.information'">
                        ...
                        <ww:param name="'value2'"><a href="<ww:url page="ViewWorkflowTransitionMetaAttributes.jspa"><%@ include file="basicworkflowurlparameters.jsp" %><ww:param name="'workflowStep'" value="/step/id" /><ww:param name="'workflowTransition'" value="transition/id" /></ww:url>"></ww:param>
