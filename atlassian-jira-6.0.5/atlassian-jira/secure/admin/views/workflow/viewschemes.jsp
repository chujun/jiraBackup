                                                ...
                                                <ww:property value="/draftFor(.)">
                                                    <ww:if test=".">
                                                        <span class="aui-icon aui-icon-small aui-iconfont-info icon-draft"
                                                             title="<ww:text name="'admin.schemes.workflow.draft.information.tooltip'"><ww:param name="'value0'" value="lastModifiedUser/displayName"/><ww:param name="'value1'" value="lastModifiedDate"/></ww:text>"></span>
                                                    </ww:if>
                                                </ww:property>
