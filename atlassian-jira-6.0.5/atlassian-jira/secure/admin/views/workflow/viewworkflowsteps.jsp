...
<div class="workflow-container">
    ...
    <div class="workflow-view<ww:if test="/diagramMode == false"> hidden</ww:if>" id="workflow-view-diagram">
        <div class="aui-buttons aui-buttons-vertical workflow-zoom-toggle-container">
            <button id="zoom-in" class="aui-button workflow-zoom-toggle">+</button>
            <button id="zoom-out" class="aui-button active workflow-zoom-toggle">&minus;</button>
        </div>
