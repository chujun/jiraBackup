----------------------------------------------
JIRA 6.0.5-#6102 README
----------------------------------------------

Thank you for downloading JIRA 6.0.5. This distribution comes with a
built-in Tomcat 7.0.29 application server, so it runs (almost)
out of the box.
...
2. Set the JAVA_HOME variable to where you installed Java. The Windows
   ...
   http://docs.atlassian.com/jira/docs-060/Installing+Java

3. Set your JIRA Home Directory.
   Instructions on how to set your JIRA Home Directory can be found here:

   http://docs.atlassian.com/jira/docs-060/Setting+your+JIRA+Home+Directory
...
http://docs.atlassian.com/jira/docs-060/Installing+JIRA
...
http://docs.atlassian.com/jira/docs-060/
